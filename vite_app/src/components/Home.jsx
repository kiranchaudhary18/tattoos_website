    ...
    const fetchData = async () => {
      try {
        const [imagesRes, categoriesRes, actorsRes, reviewsRes] = await Promise.all([
          fetch("https://tattoos-website-r5za.onrender.com/api/offer"),
          fetch("https://tattoos-website-r5za.onrender.com/api/categories"),
          fetch("https://tattoos-website-r5za.onrender.com/api/actors"),
          fetch("https://tattoos-website-r5za.onrender.com/api/reviews1")
        ]);
  ...
  return (
    <div className="main">
      ...
      <div className="tattoo-artist-home">
        ...
        <div className="overlay">
          <p className="home-text-dis">DISCOVER TATTOO FOR YOU</p>
      ...
      <div className="artist-img-home">
        ...
        <div className="poufa">
          <img className="eric-1" src="https://res.cloudinary.com/dnbayngfx/image/upload/v1738815384/IMG_3884_1_n7nhl2.png"/>
        </div>
      </div>
      <div className="artist-name">
        <h2 className="name">Eric D`suza</h2>
              ...
              <div className="category-row">
                {categories.slice(0, 3).map((category, index) => (
                  <Link key={index} to={`/our-categories/${category.name.toLowerCase()}`} className="category-card">
                    <img src={category.imageUrl || category.imageurl} alt={category.name} className="category-image" />
                    <h3 className="category-name">{category.name}</h3>
                  </Link>
                ))}
              </div>
